  ...
  <div class="container mx-auto px-6 py-8">
    ...
    <div v-if="apiData?.blogs.length" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        ...
        <p class="text-gray-500 text-sm mb-4">Author: <NuxtLink :to="`/profile/${item.author_username}`" class="hover:underline"  >{{ item.author_username }}</NuxtLink></p>
        <NuxtLink
    ...
    <!-- Error Icon -->                                                                                                                                                
    <div class="mb-6">                                                                                                                                                 
      <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">                   
        <path                                                                                                                                                          
